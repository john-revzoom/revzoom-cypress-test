...
export default function Signup() {
  ...
  async function onSignUp(): Promise<any> {
    ...
    try {
      const result = await AuthenticationController.signUp(email, password, firstName, lastName).then(
  ...
  return (
    <AuthWrapper title={SIGNUP_PAGE_HEADER} description={SIGNUP_PAGE_SUB_HEADER} onSocialButtonClick={onSSOLoginClick}>
      <SignupBlock
