...
const ImageViewer = ({
  ...
  useEffect(() => {
    if (selectedImage && imageWrapperDiv.current) {
      setImageSize({
        width: "auto",
        height: (imageWrapperDiv.current?.clientHeight * zoom) / 100
      });
  ...
  return (
    <>
      ...
      <div className={styles.imageWrapper} ref={imageWrapperDiv}>
        <div className={styles.cropWrapper} data-cy="crop-wrapper-image">
          <div style={{ position: "relative" }}>
            ...
            <img ref={renderedImage} src={selectedImage.url} height={imageSize.height} onLoad={onImageOnLoad} />
            <SmartCropCanvas
            ...
            markers?.map((e: any, i: number) => (
              <div
                ...
                style={{
                  ...
                  top: `${percentageToPxConvert(renderedImage.current?.clientHeight!, e.y)}px`,
